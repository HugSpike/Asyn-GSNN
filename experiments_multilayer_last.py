...
class Graph_Net(nn.Module):
    ...
    def forward(self, data):
        ...
        if data.spike_node is None:
            ...
            return gcn_matrix1, out, fused_features1, mu_0, logvar_0, mu_1, logvar_1
        else:
            ...
            return gcn_matrix2, out, fused_features2, mu_0, logvar_0, mu_1, logvar_1
    ...
    for dataset_name in datasets:
        ...
        for model_type in teacher_models:
            ...
            optimizer = torch.optim.Adam([
                {'params': model.sgcn_student1.SGCN.parameters(), 'lr': 0.001,
                 'weight_decay': 0.01},
                {'params': model.sgcn_student2.SGCN.parameters(), 'lr': 0.001,
                 'weight_decay': 0.01},
